...
[assembly: OwinStartup(typeof(NttuShop.Web.App_Start.Startup))]

namespace NttuShop.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(NttuShopDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<NttuShopDbContext>());
