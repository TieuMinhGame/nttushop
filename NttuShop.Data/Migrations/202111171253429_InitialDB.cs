    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ProductCatogories", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
            
            CreateTable(
                "dbo.ProductCatogories",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 256),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "CategoryID", "dbo.ProductCatogories");
            ...
            DropTable("dbo.Pages");
            DropTable("dbo.ProductCatogories");
